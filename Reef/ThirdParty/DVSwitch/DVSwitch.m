...
- (instancetype)initWithStringsArray:(NSArray *)strings
{
    ...
    UIColor* clrSelected = NAVI_COLOR;
    
    self.backgroundColor    = clrSelected;//[UIColor colorWithRed:70/255.0 green:70/255.0 blue:70/255.0 alpha:1.0];
    
    self.sliderColor        = [UIColor whiteColor];
    self.labelTextColorInsideSlider     = clrSelected;//[UIColor blackColor];
    ...
    self.font = [UIFont fontWithName:MAIN_BOLD_FONT_NAME size:16.f];
