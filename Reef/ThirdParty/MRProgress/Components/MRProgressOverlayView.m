...
- (void)commonInit {
    ...
    self.titleLabel.attributedText = [[NSAttributedString alloc] initWithString:@"Uploading..." attributes:@{
        NSForegroundColorAttributeName: DARK_GRAY_COLOR,
        NSFontAttributeName:            [UIFont fontWithName:MAIN_FONT_NAME size:15.f],
