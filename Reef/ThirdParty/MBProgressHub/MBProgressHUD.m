...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.color = nil;
		self.labelFont = [UIFont fontWithName:MAIN_FONT_NAME size:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont fontWithName:MAIN_FONT_NAME size:kDetailsLabelFontSize];
